package org.jeecg.modules.qywx.api.conversation;
...
public class ConversationAPI {
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.conversation.ConversationAPI.class);
	/**创建会话信息URL*/
