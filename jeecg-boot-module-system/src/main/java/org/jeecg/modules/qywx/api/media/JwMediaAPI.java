package org.jeecg.modules.qywx.api.media;
...
public class JwMediaAPI {
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.media.JwMediaAPI.class);
	//上传临时性图文素材
...
public static void main(String[] args) {
	 ...
	 */
	 ...
	 com.jeecg.qywx.api.media.JwMediaAPI.sendMedia(fileType,filePath, accessToken.getAccesstoken());//测试结果{"created_at":1462426106,"media_id":"1cjeJstIy7hU0FPsIEnXAj4QgTZZLVqI0Tjqamd8LzAUuGO6hMREqw-fUgiE2mpgD9Vw8qTWoIyhKa4-KF7PbBQ","type":"image"}
