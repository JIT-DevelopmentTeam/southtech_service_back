package org.jeecg.modules.qywx.api.message;
...
public class JwMessageAPI {
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.message.JwMessageAPI.class);
	//发送消息（post）
...
//测试
	 public static void main(String[] args){
		...
		text.setText(text1);
		text.setSafe("0");
		com.jeecg.qywx.api.message.JwMessageAPI.sendTextMessage(text, accessToken.getAccesstoken());
...
*/
	...
	//	 NewsEntity newsEntity=new NewsEntity();
		...
		newsEntity1.setArticles(new NewsArticle[] {newsArticles1 ,newsArticles});
		 ...
		 com.jeecg.qywx.api.message.JwMessageAPI.sendNewsMessage(news, accessToken.getAccesstoken());
