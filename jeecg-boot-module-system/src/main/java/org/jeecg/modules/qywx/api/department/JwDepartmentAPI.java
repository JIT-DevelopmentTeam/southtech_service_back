package org.jeecg.modules.qywx.api.department;
...
public class JwDepartmentAPI {
	...
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.department.JwDepartmentAPI.class);
...
//			JwDepartmentAPI.deleteDepart(7,accessToken.getAccesstoken());
			...
			com.jeecg.qywx.api.department.JwDepartmentAPI.createDepartment(department, accessToken.getAccesstoken());
