package org.jeecg.modules.qywx.api.core.util;
...
//		JSONObject object = WXUpload.upload(accessToken.getAccesstoken(), "image", "file:///D:/shjjj.jpg");
		JSONObject object = com.jeecg.qywx.api.core.util.WXUpload.upload(accessToken.getAccesstoken(), "image", "http://127.0.0.1:80/jeecg-p3-web/upload/shjjj.jpg");
