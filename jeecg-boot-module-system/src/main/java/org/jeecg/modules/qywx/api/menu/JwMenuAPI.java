package org.jeecg.modules.qywx.api.menu;
...
import com.jeecg.qywx.api.menu.vo.*;
...
public class JwMenuAPI {
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.menu.JwMenuAPI.class);
		...
		try {
			AccessToken accessToken = JwAccessTokenAPI.getAccessToken(JwParamesAPI.corpId, JwParamesAPI.secret);
		     ...
		     btn25.setKey("25");
		      ...
		      //创建菜单
			  com.jeecg.qywx.api.menu.JwMenuAPI.createMenu(menu, accessToken.getAccesstoken(), JwParamesAPI.agentid);
