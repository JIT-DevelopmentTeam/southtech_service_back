...
public class JwAccessTokenAPI {
	...
	private static final Logger logger = LoggerFactory.getLogger(com.jeecg.qywx.api.base.JwAccessTokenAPI.class);
	...
	public static void main(String[] args){
		try {
			AccessToken s = com.jeecg.qywx.api.base.JwAccessTokenAPI.getAccessToken(JwParamesAPI.corpId, JwParamesAPI.secret);
