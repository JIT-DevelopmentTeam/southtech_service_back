<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <contact-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></contact-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/client/client/listContactByMainId",
          delete: "/client/client/deleteContact",
          deleteBatch: "/client/client/deleteBatchContact"
        },
        dictOptions:{
         type:[],
         sourceId:[],
